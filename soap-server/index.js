...
// Definicion del metodo en el servicio web SOAP, que obtendrá los registros de la tabla 'personas' de la DB mysql
const service = {
    PersonasService: {
        PersonasPort: {
...
const wsdl = require('fs').readFileSync('personas.wsdl', 'utf8');
